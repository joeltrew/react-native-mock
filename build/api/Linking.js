...
var _Platform = require('../plugins/Platform');
    ...
    value: function () {
      function addEventListener(type, handler) {
        if (_Platform2['default'].OS === 'android') {
          ...
          (0, _invariant2['default'])(type === 'url', 'Linking only supports `url` events');
          var listener = _DeviceEventEmitter2['default'].addListener(DEVICE_NOTIF_EVENT, handler);
